//模拟一段JSON数据，实际要从数据库中读取  
  var per = [  
            /*{teacher_id:001,teacher_name:'张珊',teacher_password:123,teacher_num:123456,teacher_college:'www'},  
            {teacher_id:002,teacher_name:'李斯',teacher_password:123,teacher_num:123789,teacher_college:'www'},  
            {teacher_id:003,teacher_name:'王二',teacher_password:123,teacher_num:12354111,teacher_college:'www'},
            {teacher_id:004,teacher_name:'王武',teacher_password:123,teacher_num:123112,teacher_college:'www'},
            {teacher_id:005,teacher_name:'陈灿',teacher_password:123,teacher_num:123366,teacher_college:'www'},
            {teacher_id:006,teacher_name:'大屌',teacher_password:123,teacher_num:1236544,teacher_college:'www'},
            {teacher_id:007,teacher_name:'狗蛋',teacher_password:123,teacher_num:123645,teacher_college:'www'},
            {teacher_id:008,teacher_name:'嘴鸭',teacher_password:123,teacher_num:123654,teacher_college:'www'},
            {teacher_id:009,teacher_name:'靓女',teacher_password:123,teacher_num:1235454,teacher_college:'www'},
            {teacher_id:010,teacher_name:'帅哥',teacher_password:123,teacher_num:123654,teacher_college:'www'},
            {teacher_id:011,teacher_name:'丑比',teacher_password:123,teacher_num:123654,teacher_college:'www'}
            */];   
    
  window.onload = function(){  //窗口加载事件
      var teacher_list = document.getElementById('teacher_list');  
        
      for(var i = 0;i < per.length; i++){ //遍历一下json数据  
          var trow = getDataRow(per[i]); //定义一个方法,返回tr数据  
          teacher_list.appendChild(trow);  
       }  
      }  
  ...
  function getDataRow(h){  
     ...
     btnUpdate.onclick=function(){  
          showLayer('updateteacher',600,450)
         }  
